package com.cch.common.utils.list;
...
//			for (String attrValueB : StringUtil.split(attrValueTwos, ",")){
//				try {
			...
			if (ss != null && ss.length == 2){
				Collections.sort(list, new Comparator<T>() {
					...
					public int compare(T o1, T o2) {
						String s1 = StringUtil.EMPTY, s2 = StringUtil.EMPTY;
						if (o1 instanceof Map){
							s1 = ObjectUtil.toString(((Map)o1).get(ss[0]));
							s2 = ObjectUtil.toString(((Map)o2).get(ss[0]));
						}else{
							s1 = ObjectUtil.toString(ReflectUtils.invokeGetter(o1, ss[0]));
							s2 = ObjectUtil.toString(ReflectUtils.invokeGetter(o2, ss[0]));
						}
						if ("asc".equals(ss[1])){
