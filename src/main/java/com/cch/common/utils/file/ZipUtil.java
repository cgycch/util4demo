...
public class ZipUtil {
	...
	public static void zipFile(String zip, List<File> srcFiles) {
		try {
			if (zip.endsWith(".zip") || zip.endsWith(".ZIP")) {
				...
				System.out.println("target file[" + zip + "] not end with '.zip' ");
			}
		} catch (Exception e) {
			System.out.println("zip file became error: " + e.getMessage());
		}
	}
	...
	public static void main(String[] args) {
		...
		String zip = "C:\\Users\\cch\\Desktop\\zipout.zip";
		List<File> srcFiles = Arrays.asList(new File("C:\\Users\\cch\\Desktop\\demo").listFiles());
		zipFile(zip, srcFiles);
		//String descDir = "C:\\Users\\cch\\Desktop\\zipout";
		//upzipFile(zip, descDir);
